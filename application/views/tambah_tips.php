...
<!--                                    <script type="text/javascript" src="ckeditor/style.js"></script>-->
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>Judul Tips:</td>
                                            <td><input type="text" name="judul_tips" placeholder="judul tips" class="judul_tips" id="judul_tips" required></td>
                                        </tr>
                                        <tr>
                                            <td>Deskripsi Tips:</td>
                                            <td><textarea type="text" name="deskripsi_tips" placeholder="write a description..." class="ckeditor" id="deskripsi_tips" required="" style="margin: 0px 0px 9px; height: 302px; width: 615px;"></textarea></td>
                                        </tr>
                                        <tr>
                                            <td>Tanggal:</td>
                                            <td><select name=Tgl >
