...
<section id="content">
    <div class="sub-content">
        <div class="container">
            <div class="row">
                <div class="span12">
                    <h4 class="bot-0">UPDATE EVENT</h4>
                </div>
            </div>
            <div class="row">
                        ...
                        <td width="97%">
                            <center>
                                ...
                                <table>
                                    <h5>
                                        <?php
                                        echo "Update untuk ID Event :  $id_event";
                                        echo form_open('Update/edit_event/'.$id_event);
                                        ?>
                                    </h5>
                                    <br>
                                    <tr>
                                        <td>Judul Event:</td>
                                        <td><input type="text" name="judul" placeholder="" class="judul" id="judul"></td> 
                                    </tr>
                                    <tr>
                                        <td>Deskripsi Event:</td>
                                        <td><textarea type="text" name="deskripsi" class="deskripsi" id="deskripsi"
